...
export type BillsQuery = { __typename?: 'Query', bills: { __typename?: 'PaginatedBills', total: number, hasMore: boolean, items: Array<{ __typename?: 'Bill', congress: number, billType: string, billNumber: number, introducedDate?: string | null | undefined }> } };
