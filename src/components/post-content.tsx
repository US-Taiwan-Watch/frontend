...
export const PostContent: React.FC<{ post: PublicPostQuery['publicArticle'] }> = ({ post }) => {
  if (!post) {
    return <></>;
  }
  ...
  return (
    <Container sx={{ paddingBottom: 10 }}>
      ...
      <Box alignItems="center" sx={{ paddingTop: 3, display: 'flex', flexDirection: 'column' }}>
        ...
        {post.imageSource && <img src={post.imageSource} style={{ paddingTop: 10, maxWidth: "100%", maxHeight: "50vh" }} />}
      </Box>
